...
const WHATSAPP_MSG     = 'Hola Catalina, vi tu portafolio y me interesa cotizar un proyecto. Te cuento brevemente lo que necesito:'
...
const channels = [
  {
    ...
    // href: `https://mail.google.com/mail/?view=cm&to=${EMAIL}&su=${encodeURIComponent(EMAIL_SUBJECT)}&body=${encodeURIComponent(EMAIL_BODY)}`,
    external: true,
  },
  {
    icon: '💬',
        ...
        <div style={{ maxWidth: '600px' }}>
          ...
          >
            ...
            <h2 style={{
              ...
              ¿Necesitas una web o sistema que funcione?<br />
              <span style={{
                color: 'var(--cyan)',
          ...
          >
            <span style={{
              ...
              boxShadow: 'rgb(34, 197, 94) 0px 0px 8px',
            }} />
  ...
  return (
    <a
      ...
      style={{
        ...
        boxShadow: hovered ? '0 0 20px var(--cyan-glow)' : 'none',
        color: 'inherit',
      }}
    >
      ...
      <div style={{ flex: 1 }}>
        ...
        <div style={{
          ...
          textShadow: hovered ? '0 0 14px var(--cyan-glow)' : 'none',
        }}>{value}</div>
      </div>
      <span style={{
        fontFamily: 'var(--font-mono)',
